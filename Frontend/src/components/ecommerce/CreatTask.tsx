...
const CreateTaskUI: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        setAssignedToOptions(data.filter((user: any) => user.role === "TL"));
  ...
  const renderFileDropArea = (file: File | null, name: keyof TaskType, label: string) => (
    <div
      ...
      className="relative flex flex-col justify-center items-center border-2 border-dashed border-gray-500 rounded-md p-6 mb-2 cursor-pointer hover:border-blue-500 transition bg-gray-700 text-gray-100"
    >
    ...
    <>
      ...
      <div className="min-h-screen w-full bg-gray-900 flex justify-center py-10 px-4">
        <div className="w-full max-w-6xl bg-gray-800 p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl font-semibold text-center text-blue-400 mb-8">Create New Task</h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full items-stretch">
              ...
              <div className="flex-1">
                ...
                <input type="text" name="sowUrl" value={task.sowUrl} onChange={handleChange}
                  placeholder="Enter SOW Document URL" className="w-full h-18 p-3 rounded-md bg-gray-700 border border-gray-600 text-gray-100" />
                {renderError("sowUrl")}
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full items-stretch">
              ...
              <div className="flex-1">
                ...
                <input type="text" name="inputUrl" value={task.inputUrl} onChange={handleChange}
                  placeholder="Enter Input Document URL" className="w-full h-18 p-3 rounded-md bg-gray-700 border border-gray-600 text-gray-100" />
