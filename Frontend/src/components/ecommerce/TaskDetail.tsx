...
//           {/* SUBMISSION */}
//           <Section title="Submission" icon={<FileText size={18} className="text-blue-400" />}>
//             {submission ? (
//               <div className="grid md:grid-cols-2 gap-x-8 gap-y-4">
//                 <div className="mb-4">
//                    <label className="block text-[14px] text-gray-100 mb-1">
//     Sample Output Data
//   </label>
...
const TaskDetail: React.FC = () => {
  ...
  if (domainParam && task.submissions) submission = task.submissions[domainParam] || null;
  if (!submission && !domainParam && task.submissions) {
    const entries = Object.entries(task.submissions || {});
    if (entries.length === 1) {
      submission = entries[0][1];
